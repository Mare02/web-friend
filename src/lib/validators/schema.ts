...
export const qrCodeSchema = z.object({
	text: z
		...
		.max(2000, 'Text too long for QR code'),
...
export type RecentBlogsByCategory = z.infer<
	typeof recentArticlesByCategorySchema
>;
...
export type RobotsValidateResponse = z.infer<
	typeof robotsValidateResponseSchema
>;
