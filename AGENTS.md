...
Syntax and Formatting
  ...
  - Use declarative JSX.
  - Always use semicolons at the end of every statement in all JavaScript and TypeScript code.
  - Never omit semicolons, even in single-line or concise syntax.
...
Key Conventions
  ...
  - always use web search for latest information on packages and implementations
  - always use pnpm instead of npm

Follow latest Next.js docs for Data Fetching, Rendering, and Routing.
